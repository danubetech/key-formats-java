...
public class PrivateKeySignerFactory {
    ...
    public static PrivateKeySigner<?> privateKeySignerForKey(KeyTypeName keyTypeName, String algorithm, Object privateKey) {
        ...
        if (KeyTypeName.RSA.equals(keyTypeName)) {
            ...
            if (JWSAlgorithm.ES256KS.equals(algorithm)) return new secp256k1_ES256KS_PrivateKeySigner((ECKey) privateKey);
            if (JWSAlgorithm.MUSIG2.equals(algorithm)) return new secp256k1_MUSIG2_PrivateKeySigner((ECKey) privateKey);
